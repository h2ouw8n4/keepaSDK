    ...
    static private func initialize() {
        dispatch_once(&once) {
            ...
            Decoders.addDecoder(clazz: Category.self) { (source: AnyObject) -> Category in
                ...
                instance.domainId = Category.DomainId(rawValue: (sourceDictionary["domainId"] as? String) ?? "") 
                instance.catId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["catId"])
                ...
                instance.highestRank = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["highestRank"])
                instance.productCount = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["productCount"])
                return instance
            }
        }
    }
