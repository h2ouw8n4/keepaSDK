...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .termsOfServiceUrl("https://keepa.com/#!api")
            .version("1.0.0")
            .contact(new Contact("","", "info@keepa.com"))
            .build();
    }

    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.keepa.base-path:/magicCashew/keepa/1.0.0}") String basePath) {
