...
public class MainApiVerticle extends AbstractVerticle {
    ...
    public void deployVerticles(Future<Void> startFuture) {
        ...
        vertx.deployVerticle("org.openapitools.server.api.verticle.CategoryApiVerticle", res -> {
            if (res.succeeded()) {
                LOGGER.info("CategoryApiVerticle : Deployed");
            } else {
                startFuture.fail(res.cause());
                LOGGER.error("CategoryApiVerticle : Deployment failed");
            }
        });
        
        vertx.deployVerticle("org.openapitools.server.api.verticle.ProductApiVerticle", res -> {
            if (res.succeeded()) {
