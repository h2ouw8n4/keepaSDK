...
public enum DomainIdEnum {
    ...
    NUMBER_1(Integer.valueOf(1)), NUMBER_2(Integer.valueOf(2)), NUMBER_3(Integer.valueOf(3)), NUMBER_4(Integer.valueOf(4)), NUMBER_5(Integer.valueOf(5)), NUMBER_6(Integer.valueOf(6)), NUMBER_7(Integer.valueOf(7)), NUMBER_8(Integer.valueOf(8)), NUMBER_9(Integer.valueOf(9)), NUMBER_10(Integer.valueOf(10)), NUMBER_11(Integer.valueOf(11)), NUMBER_12(Integer.valueOf(12)), NUMBER_13(Integer.valueOf(13));
  ...
  private @Valid DomainIdEnum domainId;
  private @Valid Integer catId;
  private @Valid String name;
  private @Valid List<Integer> children = new ArrayList<Integer>();
  private @Valid Integer parent;
  private @Valid Integer highestRank;
