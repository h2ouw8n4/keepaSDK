...
open class ProductAPI: APIBase {
     ...
     */
    public enum Domain_product: Int32 { 
        case _1 = 1
        case _2 = 2
        case _3 = 3
        case _4 = 4
     ...
     */
    open class func product(key: String, domain: Domain_product, asin: String? = nil, code: String? = nil, completion: @escaping ((_ data: [Category]?, _ error: ErrorResponse?) -> Void)) {
