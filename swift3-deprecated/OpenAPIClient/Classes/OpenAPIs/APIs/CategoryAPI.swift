...
open class CategoryAPI: APIBase {
     ...
     */
    public enum Domain_category: Int32 { 
        case _1 = 1
        case _2 = 2
        case _3 = 3
        case _4 = 4
     ...
     */
    public enum Parents_category: Int32 { 
        case _0 = 0
        case _1 = 1
    }
     ...
     */
    open class func category(key: String, domain: Domain_category, category: Int32, parents: Parents_category, completion: @escaping ((_ data: [Category]?, _ error: ErrorResponse?) -> Void)) {
     ...
     */
    open class func categoryWithRequestBuilder(key: String, domain: Domain_category, category: Int32, parents: Parents_category) -> RequestBuilder<[Category]> {
        let path = "/category"
