...
request_param_info('Category', 'key') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'binary'},
...
request_param_info('Category', 'domain') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'integer'},
...
request_param_info('Category', 'category') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'integer'},
...
request_param_info('Category', 'parents') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'integer'},
...
request_param_info('Product', 'key') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'binary'},
...
request_param_info('Product', 'domain') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'integer'},
...
request_param_info('Product', 'asin') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'binary'},
...
request_param_info('Product', 'code') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'binary'},
...
validate_response('Category', 200, Body, ValidatorState) ->
    validate_response_body('list', 'category', Body, ValidatorState);
validate_response('Category', 400, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);


validate_response('Product', 200, Body, ValidatorState) ->
    validate_response_body('list', 'category', Body, ValidatorState);
validate_response('Product', 400, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
