...
public abstract class ProductApiService {
    public abstract Response product( @NotNull String key, @NotNull Integer domain,String asin,String code,SecurityContext securityContext) throws NotFoundException;
}
