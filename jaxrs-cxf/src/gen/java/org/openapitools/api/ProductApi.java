...
public interface ProductApi  {
    ...
    @ApiOperation(value = "Retrieve the product for the specified ASIN and domain.", tags={ "product" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "search results matching criteria", response = Category.class, responseContainer = "List"),
        @ApiResponse(code = 400, message = "bad input parameter") })
    public List<Category> product(@QueryParam("key") @NotNull  String key, @QueryParam("domain") @NotNull  Integer domain, @QueryParam("asin")  String asin, @QueryParam("code")  String code);
}
