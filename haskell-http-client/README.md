## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Keepa API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Keepa API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Keepa                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | keepa                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | KeepaConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | KeepaRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Keepa.Client    | use the "dispatch" functions to send requests       |
| Keepa.Core      | core funcions, config and request types             |
| Keepa.API       | construct api requests                              |
| Keepa.Model     | describes api models                                |
| Keepa.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Keepa.ModelLens | lenses for model fields                             |
| Keepa.Logging   | logging functions and utils                         |
