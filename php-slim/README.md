# php-base - PHP Slim Server library for Keepa API
...
------------ | ------------- | ------------- | -------------
*AbstractCategoryApi* | **category** | **GET** /category | Returns Amazon category information from Keepa API.
*AbstractProductApi* | **product** | **GET** /product | Retrieve the product for the specified ASIN and domain.
