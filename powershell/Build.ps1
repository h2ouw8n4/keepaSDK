...
$Manifest = @{
    ...
    Description = 'Org.OpenAPITools - the PowerShell module for Keepa API'

    RootModule = 'Org.OpenAPITools.psm1'
    Guid = '{A639829A-AF0B-48BC-96B9-BB174569ACB6}' # Has to be static, otherwise each new build will be considered different module
